...
urlpatterns = [
    ...
    path("app/registration/signup/", views.signup, name='signup'),
    path("app/registration/login/", views.login, name='login'),
    path("app/registration/logout/", views.logout, name='logout'),
